          ...
          >
            ...
            >
              ...
              >
                {textLines.map((l, i) => (
                  <span
                    className="sm-toggle-line block h-[1em] leading-none dark:text-[#e9e9ef] text-black"
                    key={i}
                  >
                    {l}
                  </span>
            ...
            <span
              ref={iconRef}
              className="sm-icon relative w-[14px] h-[14px] shrink-0 inline-flex items-center justify-center [will-change:transform]  dark:text-[#e9e9ef] text-black"
              aria-hidden="true"
            >
              <span
                ref={plusHRef}
          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  <li
                    className="sm-panel-itemWrap relative overflow-hidden leading-none pb-6"
                    key={it.label + idx}
                  >
                    <a
                      className="sm-panel-item relative text-black font-semibold text-[4rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear no-underline pr-[1.4em] flex items-center"
                      href={it.link}
                    ...
                    >
                      {it.icon ? <it.icon className="w-10 h-10 pr-2" /> : null}
